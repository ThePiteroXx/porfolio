...
export default class SphereIcons
{
    ...
    setSphereIcons()
    {
        ...
        //Objects
        this.model.icons = this.resources.items.icons.scene.children

        this.model.sphere = this.resources.items.icons.scene.children.find(child => child.name === 'Sphere')
        this.model.sphere.material = this.model.sphereLightMaterial

        this.model.sphereIcons = this.resources.items.icons.scene
        ...
        this.model.geometrySphereAround = new THREE.SphereBufferGeometry(0.4, 30, 30)
        this.model.sphereAround = new THREE.Mesh(this.model.geometrySphereAround, this.model.sphereAroundMaterial)
    ...
    {   
        ...
        this.model.sphereLightMaterial.uniforms.uTime.value = this.time.elapsed * 0.001
        this.model.groupIcons.rotateOnAxis(this.newAxis, this.speedAnimation)

        if(this.model.icons)this.model.icons.forEach(icon => {
