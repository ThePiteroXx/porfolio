...
export default class Camera
{
    ...
    setInstance()
    {
        ...
        const realFov = ( 360 / Math.PI ) * Math.atan( this.tanFOV * ( this.config.height / this.windowHeight ) )

        // Set up
        this.instance = new THREE.PerspectiveCamera(realFov, this.config.width / this.config.height, 0.1, 100)
    ...
    resize()
    {
        ...
        this.instance.fov = ( 360 / Math.PI ) * Math.atan( this.tanFOV * ( this.config.height / this.windowHeight ) )
        this.instance.updateProjectionMatrix()

        this.modes.default.instance.aspect = this.config.width / this.config.height
        this.modes.default.instance.fov = ( 360 / Math.PI ) * Math.atan( this.tanFOV * ( this.config.height / this.windowHeight ) )
