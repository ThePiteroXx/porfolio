...
export default class World
{
    ...
    createBackgroundScene()
    {
        ...
        this.backgroundScene.colors = new Float32Array(this.backgroundScene.parameters.count * 3)
        this.backgroundScene.positions = new Float32Array(this.backgroundScene.parameters.count * 3)
        this.backgroundScene.scales = new Float32Array(this.backgroundScene.parameters.count * 1)
        ...
        for(let i=0; i < this.backgroundScene.parameters.count; i++)
        {
            ...
            this.backgroundScene.colors[i3 + 1] = this.backgroundScene.parameters.color.g
            this.backgroundScene.colors[i3 + 2] = this.backgroundScene.parameters.color.b
        ...
        this.backgroundScene.geometry.setAttribute('aScale', new THREE.BufferAttribute(this.backgroundScene.scales, 1))
        this.backgroundScene.geometry.setAttribute('color', new THREE.BufferAttribute(this.backgroundScene.colors, 3))
    ...
    {   
        ...
        if(this.backgroundScene)
        {
            for(let i=0; i < this.backgroundScene.parameters.count; i++)
            {
                ...
                if(this.backgroundScene.positions[i3 +2] > 4) this.backgroundScene.positions[i3 +2] =(Math.random() -0.5) * 3
            }
